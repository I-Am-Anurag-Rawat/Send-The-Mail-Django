"""
Django settings for SendTheMail project.
...
SECRET_KEY = 'django-insecure-+@&o8_19)su!o%sc*e@^5+e*4!@v5p7roe4hg6z(n#+r1$xwvm'
...
WSGI_APPLICATION = 'SendTheMail.wsgi.application'
